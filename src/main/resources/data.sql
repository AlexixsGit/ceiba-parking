...
insert into admin(hours_for_a_day,capacity,vehicle_type,engine_capacity,restrict_plaque_letter) values(9,10,(select t.id from vehicle_type t where t.description = 'MOTO'),500,'A');
